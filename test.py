...
def test_main(full_data, subset_data_name, latent_dim, epochs, batch_size, learning_rate, loss_temp, 
    ...
    if full_data: # If full data, pulls from full Delphes training 
        ...
        features_train = zscore_preprocess(features_dataset['x_train'], 'datasets_-1.npz')
        features_test = zscore_preprocess(features_dataset['x_test'], 'datasets_-1.npz')
    ...
    if plot: 
        ...
        test_representation = encoder.predict(features_train[:500000])
        graphing_module.plot_2D_pca(test_representation, folder, f'1_2D_PCA.png', labels = labels_train[:500000])
        graphing_module.plot_3D_pca(test_representation, folder, f'1_3D_PCA.png', labels = labels_train[:500000])
...
#         graphing_module.plot_corner_plots(test_representation, folder, f'1_PCA_Corner_Plots.png', labels_test, plot_pca=True)
    ...
    if anomaly: 
        ...
        for key in anomaly_dataset.keys(): 
            ...
            anomaly_representation = zscore_preprocess(anomaly_dataset[key], filename)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--subset_data_name', type=str, default='divisions_zscore0.npz') 
    ...
    parser.add_argument('--encoder_name', type=str, default='encoder_weights_zscore_0.h5')
